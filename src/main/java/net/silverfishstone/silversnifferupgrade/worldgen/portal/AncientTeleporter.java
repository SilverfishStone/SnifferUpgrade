package net.silverfishstone.silversnifferupgrade.worldgen.portal;
...
import net.silverfishstone.silversnifferupgrade.block.custom.SnifferPedestalBlock;

import java.util.function.Function;

public class AncientTeleporter implements ITeleporter {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;

    public AncientTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
        ...
        int y = 61;
            ...
            if (insideDimension) {
                ...
                for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                    ...
                    if (destinationWorld.getBlockState(checkPos).getBlock() instanceof SnifferPedestalBlock) {
                        doSetBlock = false;
                        break;
                    }
                }
                if (doSetBlock) {
                    destinationWorld.setBlock(destinationPos, ModBlocks.SNIFFER_PEDESTAL.get().defaultBlockState(), 3);
                }
            }
            return entity;
        }
