...
public class ConeshellEntity extends Animal implements Bucketable {
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(ConeshellEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public ConeshellEntity(EntityType<? extends ConeshellEntity> pEntityType, Level pLevel) {
        ...
        this.moveControl = new ConeshellEntity.NautilusControl(this);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new ConeshellEntity.NautilusSwimGoal(this));
    ...
    public ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.CONESHELL_BUCKET.get());
    }
    ...
    public ConeshellEntity getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.CONESHELL.get().create(pLevel);
    }
    ...
    static class NautilusControl extends MoveControl {
        ...
        public void tick() {
            ...
            if (this.operation == Operation.MOVE_TO && !this.nautilus.getNavigation().isDone()) {
