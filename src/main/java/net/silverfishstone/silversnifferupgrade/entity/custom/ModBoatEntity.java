...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            ...
            case SPIKETIP -> ModItems.SPIKETIP_BOAT.get();
            case TREE_FERN -> ModItems.TREE_FERN_BOAT.get();
        };
    }
    ...
    public enum Type implements StringRepresentable {
        ...
        SPIKETIP(ModBlocks.SPIKETIP_PLANKS.get(), "spiketip"),
        TREE_FERN(ModBlocks.TREE_FERN_PLANKS.get(), "tree_fern");
